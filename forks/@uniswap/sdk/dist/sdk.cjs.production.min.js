...
var tt,
  ...
  nt =
    ...
    (J[exports.ChainId.AMBTEST] = new z(
  ...
  lt = (function () {
    function t(e, n) {
      ...
      ;(this.liquidityToken = new z(r[0].token.chainId, t.getAddress(r[0].token, r[1].token), 18, 'FLP', 'Firepot-LP')),
        (this.tokenAmounts = r)
    }
...
;(exports.JSBI = i),
  ...
  (exports.AMBER = $),
  (exports.FACTORY_ADDRESS = '0xfA0a6F9d10F1f90cD8e90F0801fAed93259bd343'),
  (exports.Fetcher = bt),
  (exports.Fraction = at),
